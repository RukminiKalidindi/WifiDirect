...
public class WifiListAdapter extends RecyclerView.Adapter<WifiListAdapter.CustomViewHolder>  {
    ...
    public WifiListAdapter(Context context, List<WifiP2pDevice> wifiP2pDevices, callback callback) {
...
//        if(device.deviceAddress == "8a:29:9c:92:08:1d" || device.deviceAddress == "8a:29:9c:92:08:21" || device.deviceName.equalsIgnoreCase("[Phone] Galaxy J7 Crown")) {
