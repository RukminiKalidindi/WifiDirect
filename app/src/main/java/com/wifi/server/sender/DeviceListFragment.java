...
import com.wifi.server.callback;
import com.wifi.server.dialogs.AnimationView;

import java.util.ArrayList;

public class DeviceListFragment extends BaseFragment implements RecyclerItemClickListener.OnItemClickListener, callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        wifiListAdapter = new WifiListAdapter(activity, new ArrayList<WifiP2pDevice>(), this);
    ...
    @Override
    public void call(WifiP2pDevice wifiP2pDevice) {
        ((SenderActivity)activity).redirectToProcessScreen(wifiP2pDevice);
    }
}
